...
final class LedgerTests: XCTestCase {
    ...
    func testValidateCommodityUsageDatesIntegration() throws {
        ...
        // Add balance using commodity before opening date
        let account = Account(name: TestUtils.cash)
        try ledger.add(account)
        ...
        // Should have errors from transaction, price, and balance
        XCTAssertTrue(commodityUsageErrors.count >= 3, "Should have commodity usage errors from transaction, price, and balance")
    }
    ...
    func testValidateCommodityUsageDatesIntegrationValid() throws {
        ...
        // Add balance using commodity on opening date
        let account = Account(name: TestUtils.cash)
        try ledger.add(account)
